...
<div class="edac-av-calendar-wrap">
    ...
    <?php if($edac_data['edac_legend']){?>
        <div class="edac-legend-wrap">
            <span class="edac-legend-color-box <?php if($edac_data['edac_layout']==1){echo 'edac-legend-box';}else{echo 'edac-sec-legend-box';}?>"><?php if($edac_data['edac_layout']==2){ echo '01';}?></span><span class="edac-legend-text"><?php echo esc_attr($edac_data['edac_legend_text'])?></span>
        </div>
    <?php }?>
